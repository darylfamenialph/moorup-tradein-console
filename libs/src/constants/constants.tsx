...
export const MODAL_TYPES = {
  ...
  CUSTOMIZE_COLUMNS_USER_MANAGEMENT_USERS: 'CUSTOMIZE_COLUMNS_USER_MANAGEMENT_USERS',
  CUSTOMIZE_COLUMNS_PROMOTION_MANAGEMENT_PROMOTIONS: 'CUSTOMIZE_COLUMNS_PROMOTION_MANAGEMENT_PROMOTIONS',
  CUSTOMIZE_COLUMNS_PROMOTION_MANAGEMENT_CLAIMS: 'CUSTOMIZE_COLUMNS_PROMOTION_MANAGEMENT_CLAIMS',
  CUSTOMIZE_COLUMNS_PROMOTION_MANAGEMENT_PAYMENT: 'CUSTOMIZE_COLUMNS_PROMOTION_MANAGEMENT_PAYMENT',
  CUSTOMIZE_COLUMNS_ACTIONABLES_FOLLOW_UP_DEVICE_NOT_SENT: 'CUSTOMIZE_COLUMNS_ACTIONABLES_FOLLOW_UP_DEVICE_NOT_SENT',
  CUSTOMIZE_COLUMNS_ACTIONABLES_FOLLOW_UP_REVISION_OFFER: 'CUSTOMIZE_COLUMNS_ACTIONABLES_FOLLOW_UP_REVISION_OFFER',
  CUSTOMIZE_COLUMNS_ACTIONABLES_FOLLOW_UP_RECYCLE_OFFER: 'CUSTOMIZE_COLUMNS_ACTIONABLES_FOLLOW_UP_RECYCLE_OFFER',
  CUSTOMIZE_COLUMNS_ACTIONABLES_LOCKED_DEVICES_FOR_FOLLOW_UP: 'CUSTOMIZE_COLUMNS_ACTIONABLES_LOCKED_DEVICES_FOR_FOLLOW_UP',
  CUSTOMIZE_COLUMNS_ACTIONABLES_LOCKED_DEVICES_FOR_RETEST: 'CUSTOMIZE_COLUMNS_ACTIONABLES_LOCKED_DEVICES_FOR_RETEST',
  CUSTOMIZE_COLUMNS_ACTIONABLES_PAYMENT_ACTION_NEEDED: 'CUSTOMIZE_COLUMNS_ACTIONABLES_PAYMENT_ACTION_NEEDED',
  CUSTOMIZE_COLUMNS_ACTIONABLES_DEVICES_WITH_BOX: 'CUSTOMIZE_COLUMNS_ACTIONABLES_DEVICES_WITH_BOX',
  CUSTOMIZE_COLUMNS_ACTIONABLES_DEVICES_FOR_RETURN: 'CUSTOMIZE_COLUMNS_ACTIONABLES_DEVICES_FOR_RETURN',
  CUSTOMIZE_COLUMNS_ACTIONABLES_DEVICES_FOR_RECYCLE: 'CUSTOMIZE_COLUMNS_ACTIONABLES_DEVICES_FOR_RECYCLE',
  CUSTOMIZE_COLUMNS_ACTIONABLES_DEVICES_TAKEN_FOR_INVENTORY: 'CUSTOMIZE_COLUMNS_ACTIONABLES_DEVICES_TAKEN_FOR_INVENTORY',
  CUSTOMIZE_COLUMNS_ORDER_MANAGEMENT_ORDERS: 'CUSTOMIZE_COLUMNS_ORDER_MANAGEMENT_ORDERS',
  CUSTOMIZE_COLUMNS_ORDER_MANAGEMENT_DISCREPANCY: 'CUSTOMIZE_COLUMNS_ORDER_MANAGEMENT_DISCREPANCY',
