...
export const setAddPromotionDetailsPayload =
...
export const setAddPromotionClaimsPayload =
  (payload: any) => (dispatch: any) => {
    dispatch({
...
export const setAddPromotionStepsPayload =
  (payload: any) => (dispatch: any) => {
    dispatch({
...
export const setAddOrderPromotionClaimPayload =
  (payload: any) => (dispatch: any) => {
    dispatch({
...
export const setAddPromotionConditionPayload =
  (payload: any) => (dispatch: any) => {
    dispatch({
...
export const setAddPromotionEligibilityAndFaqsPayload =
  (payload: any) => (dispatch: any) => {
    dispatch({
...
export const getPromotionClaims =
  (payload: any, platform: string, useOldAPI = false, signal?: AbortSignal) =>
  (dispatch: any, token?: string) => {
    dispatch({
    ...
    axiosInstance(token, useOldAPI)
      .get(`/api/claims?platform=${platform}`, {
        params: payload,
        signal: signal,
      })
      .then((response) => {
...
export const updatePromotionClaimMoorupStatus =
  (payload: any, promotionClaimId: string, activePlatform: string) =>
  (dispatch: any, token?: string) => {
    dispatch({
...
export const updatePromotionClaimStatus =
  (
    payload: any,
...
export const bulkUpdatePromotionClaimStatus =
  (payload: any, filter: any, activePlatform: string) =>
  (dispatch: any, token?: string) => {
    dispatch({
      type: types.UPDATE_PROMOTION_CLAIM_STATUS.baseType,
      payload,
...
export const bulkUpdatePromotionClaimMoorupStatus =
  (payload: any, filter: any, activePlatform: string) =>
  (dispatch: any, token?: string) => {
    dispatch({
...
export const submitOrderPromotionClaim =
  (payload: any, filter: any, activePlatform: string) =>
  (dispatch: any, token?: string) => {
    dispatch({
...
export const processPromotionClaimPayment =
  (payload: any, filter: any, activePlatform: string) =>
  (dispatch: any, token?: string) => {
    dispatch({
...
export const bulkProcessPromotionClaimPayment =
  (payload: any, filter: any, activePlatform: string) =>
  (dispatch: any, token?: string) => {
    dispatch({
    ...
    axiosInstance(token)
      ...
      .then(() => {
        ...
        sessionStorage.setItem(
          'FPC',
          JSON.stringify([...parsedIds, selectedIds]),
        );
...
export const updatePromotionClaimReceiptNumber =
  (
    payload: any,
    promotionClaimId: string,
    filter: any,
...
export const attachReceiptImage =
  (
    promotionClaimId: string,
    filter: any,
    activePlatform: string,
...
export const removeReceiptImage =
  (promotionClaimId: string, filter: any, activePlatform: string) =>
  (dispatch: any, token?: string) => {
    dispatch({
